...
import CubeBackground from "../ui/CubeBackground";
  ...
  return (
    <div className="relative w-full bg-[#010103] text-white overflow-x-hidden selection:bg-cyan-500/30">
              ...
              >
                {isMobile ? (
                  <div className="flex flex-col items-center w-full h-full justify-between pt-24 pb-20">
                    ...
                    <div className="flex-none translate-y-6">
                      <div
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center relative z-20">
                      ...
                      <div
                        className={`mt-20 translate-x-10 translate-y-12 text-[18px] tracking-[1.4em] text-cyan-400 font-black uppercase text-center drop-shadow-[0_0_12px_#00f7ff] brightness-110 ${conthrax}`}
                      >
                        Train • Transform • Transcend
                      </div>
                    </div>
      ...
      <AnimatePresence mode="wait">
        {activeDomain && (
            <DomainHoloPanel domain={activeDomain as K1000Domain} onClose={handlePanelClose} />
        )}
      </AnimatePresence>
    </div>
  );
