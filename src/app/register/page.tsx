  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-hidden bg-[#020202] text-white">
      ...
      <main className="relative z-10 flex flex-1 items-center justify-center px-4 pb-16 pt-28 md:pt-36">
        ...
        >
          {/* Label */}
          <p className={`${orbitron} text-[9px] md:text-[10px] tracking-[0.45em] uppercase text-cyan-300/60 mb-6`}>
            Intake Console
          </p>
          ...
          <motion.div
            ...
            className="mx-auto mb-8 flex h-20 w-20 items-center justify-center rounded-[24px] border border-red-400/30 bg-red-500/10 shadow-[0_0_40px_rgba(239,68,68,0.15)]"
          >
            <svg
          ...
          {/* Heading */}
          <h1 className={`${conthrax} text-3xl sm:text-5xl md:text-6xl font-black uppercase tracking-tighter leading-none mb-4`}>
            Registrations{" "}
            <span className="text-red-400 drop-shadow-[0_0_18px_rgba(239,68,68,0.4)]">
              Closed
            </span>
          </h1>

          <p className="mx-auto mt-5 max-w-lg text-sm md:text-base leading-relaxed text-white/45">
            The registration window for K‑1000 recruitment has now closed. Thank you to everyone who applied!
          </p>

          {/* Recruitment dates banner */}
          <motion.div
            className="mx-auto mt-8 flex max-w-xl flex-col items-center justify-center gap-2 rounded-[24px] border border-cyan-300/25 bg-cyan-400/[0.055] px-6 py-5 shadow-[0_0_36px_rgba(0,247,255,0.08)] sm:flex-row sm:gap-6"
            animate={{
              boxShadow: [
          ...
          >
            ...
            <span className={`${conthrax} text-base uppercase tracking-[0.12em] text-white sm:text-lg`}>
              8th &amp; 9th August 2026
            </span>
          </motion.div>
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.35, ease: "circOut" }}
            className="relative mx-auto mt-8 overflow-hidden rounded-[28px] border border-white/10 bg-white/[0.025] backdrop-blur-xl p-6 md:p-8 text-left shadow-[0_0_50px_rgba(0,0,0,0.3)]"
          >
            <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-cyan-400/60 to-transparent" />
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_0%,rgba(0,247,255,0.07),transparent_40%)] pointer-events-none" />
            <div className="relative z-10 flex flex-col gap-4 sm:flex-row sm:gap-8">
              <div className="flex-1">
                <p className={`${orbitron} text-[8px] uppercase tracking-[0.3em] text-cyan-400/50 mb-2`}>
                  What&apos;s next
                </p>
                <p className="text-xs md:text-sm leading-relaxed text-white/55">
                  Shortlisted candidates will be contacted via their registered KIIT email. Keep an eye on your inbox and our official channels for further announcements.
                </p>
              </div>
              <div className="h-px w-full bg-white/10 sm:h-auto sm:w-px sm:bg-white/10" />
              <div className="flex-1">
                <p className={`${orbitron} text-[8px] uppercase tracking-[0.3em] text-cyan-400/50 mb-2`}>
                  Stay connected
                </p>
                <p className="text-xs md:text-sm leading-relaxed text-white/55">
                  Follow K‑1000 on Instagram and LinkedIn for real-time updates, results, and future recruitment windows.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/"
              className={`${conthrax} inline-flex items-center gap-2 rounded-full border border-cyan-400/50 px-6 py-3 text-[9px] uppercase tracking-[0.22em] text-cyan-300 transition-all hover:bg-cyan-400 hover:text-black`}
            >
              Return Home <ChevronRight size={13} />
            </Link>
            <Link
              href="/domains"
              className={`${conthrax} inline-flex items-center gap-2 rounded-full border border-white/15 px-6 py-3 text-[9px] uppercase tracking-[0.22em] text-white/50 transition-all hover:border-white/30 hover:text-white/80`}
            >
              Explore Domains <ChevronRight size={13} />
            </Link>
          </div>

          <p className={`${conthrax} mt-10 text-[7px] uppercase tracking-[0.35em] text-white/20`}>
            {SITE_TAGLINE}
          </p>
        </motion.div>
      </main>
...
// ─────────────────────────────────────────────────────────────────────────────
// ORIGINAL REGISTRATION FORM — kept as dead code; restore export when reopening
// A full backup is also stored at: src/app/register/page.tsx.bak
// ─────────────────────────────────────────────────────────────────────────────
