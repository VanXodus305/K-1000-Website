        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 w-full mb-32">
          ...
          >
            <div className="absolute top-0 right-0 p-12 opacity-[0.03] pointer-events-none">
              <Globe size={400} className="text-amber-400" />
            </div>

            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                <Sparkles size={14} className="text-amber-400" />
                <span className={`${conthrax} text-white text-[10px] tracking-[0.4em] uppercase font-black`}>K-1000 Organisation</span>
              </div>

              <h1 className={`${conthrax} text-5xl md:text-8xl font-black uppercase tracking-tighter leading-none mb-8`}>
                Get in <br />
                <span className="text-amber-400 drop-shadow-[0_0_20px_rgba(245, 174, 55,0.4)]">Touch</span>
              </h1>

              <p className="text-white text-lg md:text-xl font-light leading-relaxed max-w-md">
          ...
          >
            <div className="flex-1 bg-white/[0.02] backdrop-blur-xl border border-white/5 rounded-[40px] p-10 relative overflow-hidden group">
              <div className="absolute -bottom-10 -right-10 opacity-[0.02] pointer-events-none">
                <Cpu size={300} className="text-amber-400" />
              </div>
              ...
              <div className="space-y-12 relative z-10 h-full flex flex-col justify-center">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-amber-400/80 font-bold tracking-tighter">+91 70085 88187</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-white text-base font-bold tracking-tighter hover:text-white transition-colors break-all">
                    k.1000@kiit.ac.in
                  </p>
                </div>
              </div>
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.02, backgroundColor: "#f5ae37", color: "#000" }}
              whileTap={{ scale: 0.98 }}
