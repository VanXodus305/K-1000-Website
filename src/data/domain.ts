export const domains = [
...

  {
    ...
    overview:
      "The Finance and Entrepreneurship branch builds a strong entrepreneurial and financial ecosystem within KIIT University.",
    description:
      "The Finance and Entrepreneurship branch supports student-led ventures through mentorship, financial planning, operational support, partnerships, compliance awareness, and strategic execution. It aims to create financially literate leaders, scalable student startups, and sustainable long-term impact through structured growth and real-world business exposure.",
    focusAreas: [
